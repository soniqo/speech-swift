...
- **[CSM (Conversational Speech Model)](docs/models/csm.md)** — TTS เชิงสนทนาพร้อมการโคลนเสียงแบบ zero-shot จากคลิปเสียงอ้างอิง + ทรานสคริปต์ (Sesame CSM-1B, backbone Llama-1B + โคเดก Mimi, MLX int8/fp16, 24 kHz, ภาษาอังกฤษ; Apache-2.0)
...
- **[LocalVQE v1.4-AEC](https://soniqo.audio/th/guides/echo-cancellation)** — การตัดเสียงสะท้อนอะคูสติกแบบสตรีมจากสตรีมไมโครโฟนและสัญญาณอ้างอิงการเล่นที่แยกกันและซิงโครไนซ์กัน (Core ML + ฟิลเตอร์ปรับตัวแบบเนทีฟ, 16 kHz, เวลาแฝงเชิงอัลกอริทึม 16 ms)
...
- **[Smart Turn](docs/models/smart-turn-v3.md)** — การตรวจจับจุดสิ้นสุดการพูดจากเสียง (Pipecat Smart Turn v3.2, CoreML, 8M, 23 ภาษา; ยืนยันช่วงหยุดของ Silero VAD เพื่อไม่ให้การหยุดกลางประโยคจบเทิร์นการพูด)
...
- **10 ก.ย. 2026** — [NVIDIA Nemotron VoiceChat on Apple Silicon — Full-Duplex Speech With Tools](https://blog.ivan.digital/nvidia-nemotron-voicechat-on-apple-silicon-full-duplex-speech-with-tools-6165625d55c4)
...
| [CSM](docs/models/csm.md) | ข้อความ → เสียงพูด (เชิงสนทนา, การโคลนแบบ zero-shot) | MLX | 1B (int8 / fp16) | EN |
...
| [VoiceChat 11B](docs/models/voicechat.md) | เสียงพูด → เสียงพูด + ข้อความ | MLX | 11B (INT5 / INT8) | EN |
...
| [Smart Turn v3.2](https://huggingface.co/aufklarer/Smart-Turn-v3.2-CoreML) | การตรวจจับจุดสิ้นสุดการพูด | CoreML | 8M | 23 ภาษา |
...
- **[Soniqo VoiceChat CLI](docs/inference/voicechat.md)** ([คู่มือ](https://soniqo.audio/th/guides/speech-to-speech)) — ผู้ช่วยเทอร์มินัล Nemotron 11B แบบ full-duplex ที่มีคำบรรยาย RNN-T แบบสด การจัดคิวสนทนาโดยโมเดล รายละเอียด EAR-TTS แบบปรับตัว และเครื่องมือ MCP ที่เลือกใช้ได้ การตั้งค่า Apple Reminders ที่ให้มาจะเปิดเฉพาะการสร้าง แสดงรายการ และอัปเดต
...
### การตัดเสียงสะท้อนอะคูสติก — [คู่มือฉบับเต็ม →](https://soniqo.audio/th/guides/echo-cancellation)
