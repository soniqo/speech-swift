...
Speech Swift パッケージへの参照を公開ソースで確認できる 15 個のリポジトリです。
...
**OpenAI 互換アプリ：** [AnythingLLM](https://github.com/Mintplex-Labs/anything-llm)（[マージ済みの WAV 対応](https://github.com/Mintplex-Labs/anything-llm/pull/6012)）
