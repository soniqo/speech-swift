...
Speech Swift पैकेज के सत्यापन योग्य संदर्भ वाले 16 सार्वजनिक रिपॉज़िटरी।
...
- **[CSM (Conversational Speech Model)](docs/models/csm.md)** — रेफ़रेंस क्लिप + ट्रांसक्रिप्ट से ज़ीरो-शॉट वॉयस क्लोनिंग के साथ संवादात्मक टेक्स्ट-टू-स्पीच (Sesame CSM-1B, Llama-1B बैकबोन + Mimi कोडेक, MLX int8/fp16, 24 kHz, अंग्रेज़ी; Apache-2.0)
...
- **[LocalVQE v1.4-AEC](https://soniqo.audio/hi/guides/echo-cancellation)** — अलग और सिंक्रोनाइज़ किए गए माइक्रोफ़ोन तथा प्लेबैक-रेफ़रेंस स्ट्रीम से स्ट्रीमिंग ध्वनिक प्रतिध्वनि रद्दीकरण (Core ML + नेटिव अनुकूली फ़िल्टर, 16 kHz, 16 ms एल्गोरिदमिक विलंब)
...
- **[Smart Turn](docs/models/smart-turn-v3.md)** — ऑडियो से एंड-ऑफ़-टर्न डिटेक्शन (Pipecat Smart Turn v3.2, CoreML, 8M, 23 भाषाएँ; Silero VAD के ठहराव की पुष्टि करता है ताकि वाक्य के बीच का ठहराव टर्न समाप्त न करे)
...
- **10 Sep 2026** — [NVIDIA Nemotron VoiceChat on Apple Silicon — Full-Duplex Speech With Tools](https://blog.ivan.digital/nvidia-nemotron-voicechat-on-apple-silicon-full-duplex-speech-with-tools-6165625d55c4)
...
| [CSM](docs/models/csm.md) | टेक्स्ट → स्पीच (संवादात्मक, ज़ीरो-शॉट क्लोनिंग) | MLX | 1B (int8 / fp16) | EN |
...
| [VoiceChat 11B](docs/models/voicechat.md) | स्पीच → स्पीच + टेक्स्ट | MLX | 11B (INT5 / INT8) | EN |
...
| [Smart Turn v3.2](https://huggingface.co/aufklarer/Smart-Turn-v3.2-CoreML) | एंड-ऑफ़-टर्न डिटेक्शन | CoreML | 8M | 23 भाषाएँ |
...
### ध्वनिक प्रतिध्वनि रद्दीकरण — [पूरी गाइड →](https://soniqo.audio/hi/guides/echo-cancellation)
