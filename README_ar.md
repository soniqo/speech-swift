...
اختبار أداء VoiceChat بنمط Release ‏(M5 Pro، ذاكرة 48 GB؛ كتل إدخال حية 80 ms؛ اختبار مضبوط من 120 إطارًا):
...
أرقام أول token/صوت هي زمن الحساب بعد الإحماء لأول إطار استجابة منطوق، وليست زمن تبديل الأدوار الذي تعلمه النموذج. كلا الإصدارين ما زال أبطأ من الزمن الحقيقي.
