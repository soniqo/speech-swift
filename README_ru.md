...
|--------|-----------|--------|-----|------------|
| PersonaPlex-7B (4-bit) | MLX Swift (release) | ~68мс | ~0.87 | 20с вход → 36с выход за ~31с |

> PersonaPlex работает со скоростью ~68мс/шаг — значительно ниже порога реального времени 80мс при 12.5 Гц, обеспечивая инференс **быстрее реального времени** (RTF < 1.0). И temporal transformer, и depformer квантованы до 4 бит.
...
**Инференс:** [ASR Inference](docs/inference/asr-inference.md), [TTS Inference](docs/inference/qwen3-tts-inference.md), [Forced Aligner](docs/inference/forced-aligner.md), [FireRedVAD](docs/inference/fireredvad.md), [Silero VAD](docs/inference/silero-vad.md), [Speaker Diarization](docs/inference/speaker-diarization.md), [Speech Enhancement](docs/inference/speech-enhancement.md)
...
Kokoro TTS, Qwen3-Chat, Silero VAD, Parakeet ASR, DeepFilterNet3 и WeSpeaker работают на iOS 17+ через CoreML на Neural Engine. Модели на базе MLX (Qwen3-ASR, Qwen3-TTS, PersonaPlex) требуют macOS 14+ на Apple Silicon.
